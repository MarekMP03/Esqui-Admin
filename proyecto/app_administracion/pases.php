...
$sql = "SELECT idClientes, idTarjetas, tipo, Activo, FechaExpedicion FROM tarjetas";
$result = $conn->query($sql);
$sql2 = "SELECT idClientes, Nombre, Apellido FROM clientes";
...
<div class="half-left2">
    ...
    <div class="mb-3">
        <a href="agregar_pase.html" class="btn btn-primary">Agregar pase</a>
    </div>

    <!-- Cuadro centrado -->
    <div class="card mx-auto" style="max-width: 600px;">
        <div class="card-header">Lista de pases</div>
        <div class="card-body">
            <ul class="list-group">
                <?php
                // Mostrar pases
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo $row["idTarjetas"] . " | ID Cliente: " . $row["idClientes"] . " | Tipo: " . $row["tipo"] . " | Activo: " . $row["Activo"]  . " | Fecha Expedicion: " . $row["FechaExpedicion"];
                        echo '<a href="revisar.php?idTarjetas=' . $row["idTarjetas"] . '" class="btn btn-primary btn-sm ml-auto">Revisar</a>';
